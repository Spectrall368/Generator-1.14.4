{
	...
	if (!projectileLevel.isRemote) {
		<#if input$projectile == "SmallFireball" || input$projectile == "LargeFireball" || input$projectile == "DragonFireball">Entity<#else>ProjectileItemEntity</#if> _entityToSpawn = ${input$projectile};
